...
$(document).ready(function () {
	$('.feedback').feedback();
    $(".feedback .dropdown-menu").css("height", "126px");

    $("#repBntInf").click(function() {
        $(".feedback .dropdown-menu").css("height", "126px");
        $("#boxReportBug").hide();
        $("#boxOpcoes").show();
    });
    ...
    $("#repBntInf").hover(
        function() {
            $("#repBntInf").css("width", "76px");
        }, function() {
            $("#repBntInf").css("width", "53px");
        }
    );

    $( "#bntRepProb" ).click(function() {
        $(".feedback .dropdown-menu").css("height", "300px");
        $("#boxOpcoes").hide();
        $("#boxReportBug").show();
    });
